...
class ControllerCategoria:
    ...
    def removerCategoria(self, categoriaRemover):
        ...
        X = DaoCategoria.ler()
        cat = list(filter(lambda C: C.categoria == categoriaRemover, X))
    ...
    def alterarProduto(self, nomeAlterar, novoNome, novoPreco, novaCategoria, novaQuantidade):
        ...
        if len(h) > 0:
            ...
            if len(est) > 0:
                ...
                print('O produtor que deseja alterar não existe')
            ...
            print('A categoria inforada não existe')
...
class ControllerFornecedor:
    ...
    def alterarFornecedor(self, nomeAlterar, novoNome, novoCnpj, novoTelefone, novoCategoria):
        ...
        if len(est) >0:
            ...
            if len(est) == 0:
                x = list(map(lambda x: Fornecedor(novoNome, novoCnpj, novoTelefone, novoCategoria) if(x.nome == novoNome) else(x), x))
            else:
        ...
        with open('fornecedores.txt', 'w') as arq:
            for i in x:
                ...
                arq.writelines('\n')
            print('Fornjecedor alterado com sucesso')
    ...
    def removerFornecedor(self, nome):
        ...
        with open('fornecedores.txt', 'w') as arq:
            for i in x:
                arq.writelines(i.nome + "|" + i.cnpj + "|" + i.telefone + "|" + str(i.categoria))
                arq.writelines('\n')
            print('Fornjecedor removido com sucesso')
    ...
    def mostrarFornecedores(self):
        ...
        for i in fornecedores:
            print("==========Fornecedores==========")
            print(f"Categoria Forneceida: {i.categoria}\n"
                  f"Nome: {i.nome}\n"
...
class ControllerCliente:
    def cadastrarCliente(self, nome, telefone, cpf, email, endereco):
        ...
        if len(listaCpf) > 0:
            ...
            if len(cpf) == 1 and len(telefone) >= 10 and len(telefone) <=11:
    ...
    def removerCliente(self, nome):
        ...
        if len(est) > 0:
            ...
            print('O cliente que deseja remover nao existe')
            return None
